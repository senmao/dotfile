...
" load module header
nnoremap <leader>h :read /media/sf_U/codespace/license_hdr/openBSD.hdr<CR>1Gdd32GccCreated On <C-R>=strftime("%Y-%m-%d %a %H:%M:%S")<CR><Esc>G
